import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/jinil-mini/.openclaw/workspace-gaemunity/tmp/our-little-miracle-next/repo/nuxt-src/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { getResponseStatusText, getResponseStatus, getQuery, createError, appendResponseHeader } from 'file:///Users/jinil-mini/.openclaw/workspace-gaemunity/tmp/our-little-miracle-next/repo/nuxt-src/node_modules/h3/dist/index.mjs';
import { joinRelativeURL, encodePath, joinURL } from 'file:///Users/jinil-mini/.openclaw/workspace-gaemunity/tmp/our-little-miracle-next/repo/nuxt-src/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/jinil-mini/.openclaw/workspace-gaemunity/tmp/our-little-miracle-next/repo/nuxt-src/node_modules/vue/server-renderer/index.mjs';
...
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/jinil-mini/.openclaw/workspace-gaemunity/tmp/our-little-miracle-next/repo/nuxt-src/node_modules/unhead/dist/server.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/jinil-mini/.openclaw/workspace-gaemunity/tmp/our-little-miracle-next/repo/nuxt-src/node_modules/devalue/index.js';
import { walkResolver } from 'file:///Users/jinil-mini/.openclaw/workspace-gaemunity/tmp/our-little-miracle-next/repo/nuxt-src/node_modules/unhead/dist/utils.mjs';
import { isRef, toValue, hasInjectionContext, inject, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated } from 'file:///Users/jinil-mini/.openclaw/workspace-gaemunity/tmp/our-little-miracle-next/repo/nuxt-src/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/jinil-mini/.openclaw/workspace-gaemunity/tmp/our-little-miracle-next/repo/nuxt-src/node_modules/unhead/dist/plugins.mjs';
